public class Main {
    public static void main(String[] args) {
        ...
        Griffindor heGr = new Griffindor("Hermiona Granger", 95, 90, 87, 85, 85, 75);
        Griffindor roWe = new Griffindor("Ronald Weasley", 75, 65, 45, 45, 75, 74);
        ...
        Slitherin drMa = new Slitherin("Draco Malfoy", 95, 78, 54, 85, 69, 72, 78, 95);
